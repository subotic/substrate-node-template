...
impl pallet_nicks::Config for Runtime {
	...
	// Set ReservationFee to a value of 100 units.
	...
	// Set MinLength of nick name to desidered value.
	type MinLength = ConstU32<8>;

	// Set MaxLength of nick name to desidered value.
